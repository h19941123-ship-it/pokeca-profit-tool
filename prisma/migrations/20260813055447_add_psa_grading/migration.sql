...
INSERT INTO "new_Card" ("cardNumber", "condition", "createdAt", "fxRate", "id", "imageUrl", "language", "name", "purchasePriceJpy", "purchasedAt", "rarity", "sellPriceUsd", "setName", "shippingJpy", "stock", "supplier", "updatedAt", "weightGrams") SELECT "cardNumber", "condition", "createdAt", "fxRate", "id", "imageUrl", "language", "name", "purchasePriceJpy", "purchasedAt", "rarity", "sellPriceUsd", "setName", "shippingJpy", "stock", "supplier", "updatedAt", "weightGrams" FROM "Card";
DROP TABLE "Card";
...
INSERT INTO "new_Settings" ("defaultFxRate", "ebayFeePct", "fxFeePct", "id", "minProfitJpy", "notifyPriceChangePct", "notifyProfitRatePct", "otherFeeJpy", "packingJpy", "paymentFeePct", "thresholdBuyPct", "thresholdConsiderPct", "updatedAt") SELECT "defaultFxRate", "ebayFeePct", "fxFeePct", "id", "minProfitJpy", "notifyPriceChangePct", "notifyProfitRatePct", "otherFeeJpy", "packingJpy", "paymentFeePct", "thresholdBuyPct", "thresholdConsiderPct", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
