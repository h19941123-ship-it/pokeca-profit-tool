...
INSERT INTO "new_Card" ("cardNumber", "condition", "createdAt", "fxRate", "gradingPlan", "id", "imageUrl", "language", "name", "psa10Prob", "psa10SellUsd", "psa9SellUsd", "purchasePriceJpy", "purchasedAt", "rarity", "sellPriceUsd", "setName", "shippingJpy", "stock", "supplier", "updatedAt", "weightGrams") SELECT "cardNumber", "condition", "createdAt", "fxRate", "gradingPlan", "id", "imageUrl", "language", "name", "psa10Prob", "psa10SellUsd", "psa9SellUsd", "purchasePriceJpy", "purchasedAt", "rarity", "sellPriceUsd", "setName", "shippingJpy", "stock", "supplier", "updatedAt", "weightGrams" FROM "Card";
DROP TABLE "Card";
